...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        int textPrimaryColor = context.getResources().getColor(R.color.material_pixel_blue_bright);
        int tabTextColor = context.getResources().getColor(R.color.material_pixel_blue_bright);
